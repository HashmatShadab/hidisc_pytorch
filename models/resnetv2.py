...
from timm.models._manipulate import checkpoint_seq, named_apply, adapt_input_conv
...
def resnetv2_50_gn(pretrained=False, **kwargs) -> ResNetV2:
...
if __name__ == "__main__":
    ...
    model = resnetv2_50_gn(pretrained=False)
    output = model(image)
    print(output.shape)