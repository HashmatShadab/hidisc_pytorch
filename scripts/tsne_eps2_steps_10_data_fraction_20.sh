...
--source_ckpt_path $source_ckpt_dir  --save_results_path  Results/tsne_eval_knn_results --eps 2 --steps 10 --eval_predict_batch_size 64 --data_fraction 0.2  
...
python tsne.py --data_db_root $DATA_PATH  --source_model_backbone $source_model    \
--source_exp_no $source_exp_no \
--source_ckpt_path $source_ckpt_dir  --save_results_path  Results/tsne_eval_knn_results --eps 2 --steps 10 --eval_predict_batch_size 64 --data_fraction 0.2  --load_source_from_ssl False
