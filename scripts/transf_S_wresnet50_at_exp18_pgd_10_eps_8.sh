...
#
#    python adv_eval_knn_transf.py --data_db_root $DATA_PATH  --source_model_backbone wresnet50_at --source_exp_no 18   \
...
# loop over all the checkpoints in the directory ending with .pth
for ckpt_path in Results/Baseline/wresnet50_at_exp18/checkpoint_40000.pth; do
