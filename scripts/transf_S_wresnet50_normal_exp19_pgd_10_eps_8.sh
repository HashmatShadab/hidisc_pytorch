...
##for ckpt_path in Results/Adv/wresnet50_normal_dynamicaug_true_epsilon_warmup_5000_only_adv_exp19/*_checkpoint.pth; do
##
##    echo "Source ckpt $ckpt_path,  Target ckpt $target_ckpt_dir"
##
##    python adv_eval_knn_transf.py --data_db_root $DATA_PATH  --source_model_backbone wresnet50_normal --source_exp_no 19   \
...
##
### loop over all the checkpoints in the directory ending with .pth
##for ckpt_path in Results/Adv/wresnet50_normal_dynamicaug_true_epsilon_warmup_5000_only_adv_exp19/checkpoint.pth; do
##
##    echo "Source ckpt $ckpt_path,  Target ckpt $target_ckpt_dir"
##
##    python adv_eval_knn_transf.py --data_db_root $DATA_PATH  --source_model_backbone wresnet50_normal --source_exp_no 19   \
...
#
## loop over all the checkpoints in the directory ending with .pth
#for ckpt_path in Results/Adv/wresnet50_normal_dynamicaug_true_epsilon_warmup_5000_only_adv_exp19/checkpoint_40000.pth; do
#
#    echo "Source ckpt $ckpt_path,  Target ckpt $target_ckpt_dir"
#
#    python adv_eval_knn_transf.py --data_db_root $DATA_PATH  --source_model_backbone wresnet50_normal --source_exp_no 19   \
