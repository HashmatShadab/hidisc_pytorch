...
#for ckpt_path in Results/Baseline/resnet101_normal_exp18/checkpoint_40000.pth; do
#
#    echo "Source ckpt $ckpt_path,  Target ckpt $target_ckpt_dir"
#
#    python adv_eval_knn_transf.py --data_db_root $DATA_PATH  --source_model_backbone resnet101_normal --source_exp_no 18   \
